...
<script src="js/modules_setlanguage.js"></script>
...
<script language="javascript" type="text/javascript" src="js/jspdf.plugin.autotable.min.js"></script>
<script language="javascript" type="text/javascript" src="js/html2canvas.min.js"></script>
<!-- <script language="javascript" type="text/javascript" src="js/pdfmake-master/build/pdfmake.min.js"></script>
<script language="javascript" type="text/javascript" src="js/pdfmake-master/build/vfs_fonts.js"></script> -->
...
<!-- <script language="javascript" type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.66/pdfmake.min.js"></script>
<script language="javascript" type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.66/vfs_fonts.js"></script> -->

<script>
$(function() {

    // alert('<?php //echo $ID_Store; ?>');
