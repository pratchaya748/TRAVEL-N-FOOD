...
if (!$_SESSION["ID_User"]){  //check session
	  ...
	  Header("Location: login.php"); //ไม่พบผู้ใช้กลับไปหน้า login form 
...
// --------------------------------------------------------------------------------------------------------------------
    ...
    // $data = array();
    // while($result = mysqli_fetch_assoc($qeury15)){
    //     $data[] = $result;
    // }
...
//----------------------------------------------BAR--------------------------------------------------
            ...
            function drawChart6() {
                ...
                var barchart_options = {'title':`วัตถุประสงค์หลักในการมาเที่ยวในจังหวัดนครศรีธรรมราช/ภูเก็ต/สงขลา`, 
                        'width':1200,
                        'height':500,
                        hAxis : { 
                        textStyle : {
            ...
            function drawChart7() {
                ...
                var barchart_options = {'title':'ในการมาเที่ยวของท่านนั้น ท่านชื่นชอบรับประทานอาหารประเภทไหน', 
                    'width':1200,
                    'height':500,
                    hAxis : { 
                        textStyle : {
            ...
            function drawChart8() {
                var data = google.visualization.arrayToDataTable([  
                    ...
                    <?php  
                        ...
                        {  
                            echo "['".$row["Statement"]." :".$row["Answer"]."',".$row["Amount"]."],";    
                        }  
                        ?>
                    ]);   

                var barchart_options = {'title':'ถ้านึกถึงอาหารภาคใต้ ท่านนึกถึงอาหารของจังหวัดใดต่อไปนี้มากที่สุด (เรียงลำดับ 1-3)', 
                        'width':1200,
                        'height':500,
            ...
            function drawChart9() {
                ...
                var barchart_options = {'title':'เมนูอาหารใต้ เมนูใดบ้างที่ท่านชื่นชอบ', 
                        'width':1200,
                        'height':500,
                        hAxis : { 
                        textStyle : {
            ...
            function drawChart10() {
                ...
                var barchart_options = {'title':'ท่านรับรู้ข่าวสารร้านอาหารแนะนำ/ร้านอร่อยพื้นถิ่น จากแหล่งใดบ้าง', 
                        'width':1200,
                        'height':500,
                        hAxis : { 
                        textStyle : {
            ...
            function drawChart11() {
                ...
                var barchart_options = {'title':'รายการอาหารท้องถิ่นที่ท่านชอบดูมีรายการอะไรบ้าง', 
                        'width':1200,
                        'height':500,
                        hAxis : { 
                        textStyle : {
            ...
            function drawChart12() {
                ...
                var barchart_options = {'title':'ติดตามเพจใดบ้างต่อไปนี้', 
                        'width':1200,
                        'height':500,
                        hAxis : { 
                        textStyle : {
            ...
            function drawChart13() {
                ...
                var barchart_options = {'title':'พฤติกรรมที่ท่านชอบทำเมื่อมาทานอาหารพื้นถิ่นในจังหวัดนครศรีธรรมราช ภูเก็ต และสงขลา', 
                        'width':1200,
                        'height':500,
                        hAxis : { 
                        textStyle : {
            ...
            function drawChart14() {
                ...
                var barchart_options = {'title':'ท่านรู้จักอาหารพื้นถิ่นของจังหวัดนครศรีธรรมราชหรือไม่', 
                        'width':1200,
                        'height':500,
                        hAxis : { 
                        textStyle : {
            ...
            function drawChart16() {
                ...
                var barchart_options = {'title':'ท่านรู้จักวัตถุดิบพื้นบ้านภาคใต้เหล่านี้หรือไม่', 
                        'width':1200,
                        'height':500,
                        hAxis : { 
                        textStyle : {
            ...
            function drawChart17() {
                ...
                var barchart_options = {'title':'ด้านอัตลักษณ์ของอาหารพื้นถิ่นภาคใต้', 
                        'width':1200,
                        'height':500,
                        hAxis : { 
                        textStyle : {
            ...
            function drawChart18() {
                ...
                var barchart_options = {'title':'ด้านคุณภาพของอาหารพื้นถิ่นภาคใต้', 
                        'width':1200,
                        'height':500,
                        hAxis : { 
                        textStyle : {
            ...
            function drawChart19() {
                ...
                var barchart_options = {'title':'ด้านคุณค่าของราคา', 
                        'width':1200,
                        'height':500,
                        hAxis : { 
                        textStyle : {
            ...
            function drawChart20() {
                ...
                var barchart_options = {'title':'ด้านการตลาด', 
                        'width':1200,
                        'height':500,
                        hAxis : { 
                        textStyle : {
            ...
            function drawChart21() {
                ...
                var barchart_options = {'title':'ด้านลักษณะร้านอาหารพื้นถิ่น', 
                        'width':1200,
                        'height':500,
                        hAxis : { 
                        textStyle : {
